...
type AuthService interface {
	...
	ResetPasswordEmailInit(reqData *request.ResetPasswordEmailInitRequest) (token string, errCode int, err error)
	ResetPasswordPhoneNumberInit(reqData *request.ResetPasswordPhoneNumberInitRequest) (token string, errCode int, err error)
